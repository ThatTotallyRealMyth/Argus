...
<head>
    ...
    <title>Argus security research report - {{.Task.ID}}</title>
    <style>
...
<body>
    <div class="container">
        <header><div><p class="eyebrow">Argus / Authorized Security Research</p><h1>External pen testing report</h1></div><div class="report-id">TASK {{.Task.ID}}</div></header>
        <div class="info">
        ...
        <footer>Generated by Argus. This report is based on evidence collected within the authorized scope and should be reviewed manually before submission.</footer>
    </div>
</body>
</html>`))
